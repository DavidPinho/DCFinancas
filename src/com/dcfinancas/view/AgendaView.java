...
public class AgendaView extends JFrame {
	...
	/**
	 * This method initializes pn_fila
	 * 
	...
	/**
	 * This method initializes tb_agenda
	 * 
	...
	private JTable getTb_agenda() {
		if (tb_agenda == null) {
			...
			// tb_agenda.setColumnSelectionAllowed(true);
	...
	/**
	 * This method initializes bt_atendido
	 * 
	...
	/**
	 * This method initializes br_search
	 * 
	 * @return javax.swing.JButton
	 */
	...
	public void atualizaTable(Vector<Reserva> reserva) {
		...
		for (Reserva r : reserva) {
			...
			table[i][2] = new SimpleDateFormat("dd/MM/yyyy").format(r.getData());
			table[i][3] = r.getHora();
		...
		currenteTable.setModel(new javax.swing.table.DefaultTableModel(table,
				new String[] { "Cliente", "Servi�o", "Data", "Hora" }));
		...
		int maxPage = num_reg / BDUtils.NUM_REG + 1;
	...
	/**
	 * This method initializes tb_atendidos
	 * 
	 * @return javax.swing.JTable
	 */
	...
	/**
	 * This method initializes bt_edit	
	 * 	
	 * @return javax.swing.JButton	
	 */
