...
public class ClienteChooser extends JDialog {
	...
	/**
	 * This method initializes tb_clientes	
	 * 	
			...
			bt_ok.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(l>-1){
						...
						}else if(owner instanceof EncomendaFrame){
							CarrinhoDialog c=CarrinhoDialog.getInstance();
							if(c!=null){
								c.setCliente(selected);
							}
						}
						
						ClienteChooser.this.dispose();
					}else{
						JOptionPane.showMessageDialog(ClienteChooser.this,  "Selecione um cliente por favor!","Aten��o!", JOptionPane.WARNING_MESSAGE);
					}
