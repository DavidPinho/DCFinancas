...
public class ClienteInfoFrame extends JFrame {
	...
	public static ClienteInfoFrame getInstance(int id){
	...
	private ClienteInfoFrame(int id) {
	...
	private void preencheCampos() {
		...
		lbl_cpf_cliente.setText(Integer.toString(c.getCPF()));
	...
	/**
	 * This method initializes bt_agendar	
	 * 	
	 * @return javax.swing.JButton	
	 */
