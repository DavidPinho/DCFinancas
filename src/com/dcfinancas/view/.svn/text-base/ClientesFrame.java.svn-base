...
public class ClientesFrame extends JFrame {
	...
	/**
	 * This method initializes bt_serach	
	 * 	
	...
	/**
	 * This method initializes bt_info	
	 * 	
	 * @return javax.swing.JButton	
	 */
	...
	public void atualizaTable(Vector<Cliente> clientes){
		Object[][]table=new Object[BDUtils.NUM_REG][6];
		int i=0;
		for(Cliente c:clientes){
			...
			table[i][5]= new SimpleDateFormat("dd/MM/yyyy").format(c.getData_nascimento());
